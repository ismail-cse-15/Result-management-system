...
require_once("config.php");
 ...
 <div class="container div col-sm-4" >
   ...
   <div class="container col-sm-12">
     ...
     alt="signup_logo" class="img img-circle"style="width:20%">
   </div>
   ...
   <div class="form-group">
    ...
    name="head_name" placeholder="Enter your name" value="" required>
  </div>
  <div class="form-group">
    <label for="head_id">Id</label>
    <input type="text" class="form-control"
    name="head_id" placeholder="Enter your id" value="" required>
  </div>
