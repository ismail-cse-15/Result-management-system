...
<h2 class="text-primary">  <center > <strong>For CT  </strong></center></h2>
...
<div class="container col-sm-6 ">
    ...
    <form  action="action_assign_ct.php" method="post">



<div class="form-group">
  <label for="series">For which series</label>
  <input type="number" placeholder="Enter series" class="form-control" name="series" value="">
   ...
   ?>
    ...
    <div class="form-group" >
      ...
      <!-- <select class="form-control" name="course_id"> -->
        <input type="text" name="course_id" class="form-control"  value="" required>
        <?php
echo "*Foemat : cse_****/eee_****/......";
echo "<br>";
echo "Not use capital letter";
         ?>
        <!-- <?php
        $query1="SELECT DISTINCT(course_assignment.course_id),
        course_assignment.series,course_assignment.section,
...
<div class="form-group">
  ...
  <input type="number" class="form-control" name="ct_no"
  value="" min="1" max="4" required>
