...
<div class="container col-sm-6">
  <h2 class="text-primary">  <center > <strong>For semester final
  </strong></center></h2>
<form class="" action="action_assign_semester_final1.php" method="post">
  <?php
  ...
  echo ' <div class="alert alert-warning alert-dismissible">
      <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
      <strong>Marks does not successfully assign</strong>
    </div>';

  }

  if(isset($_GET['already_assign']))
  {
  echo ' <div class="alert alert-danger alert-dismissible">
      <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
      <strong>Marks store already assign</strong>
    </div>';
  ...
  <div class="form-group">
    ...
    <div class="form-group">
      <label for="sm_marks">Marks</label>
      <input type="number" class="form-control"
      name="sm_marks" min="0" max="72" step="any"
      placeholder="Mark in range 0 to 72"
      value="" required>
