...
<div class="container col-sm-6">
  <h2 class="text-primary">  <center >
    <strong>For lab performance
  </strong></center></h2>
<form class="" action="action_assign_labperformance1.php" method="post">
  ...
  echo ' <div class="alert alert-danger alert-dismissible">
      <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
      <strong>Mark is  already assign</strong>
    </div>';
  ...
  <div class="form-group">
    ...
    <div class="form-group">
      <label for="per_marks">Marks</label>
      <input type="number" class="form-control"
      name="per_marks" min="0" max="47"
      placeholder="Mark in range 0 to 47" step="any" value="" required>
