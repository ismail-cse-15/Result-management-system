...
<div class="container col-sm-6 ">
 ...
 <h2 >  <center> </center></h2>
    <form  action="action_assign_labquize.php" method="post">
...
<!-- <select class="form-control" name="series">
  ...
  group by course_assignment.course_id ";
  $send1=mysqli_query($connection,$query1);
  while ($row1=mysqli_fetch_array($send1)){
   ...
   ?>
    ...
    <div class="form-group" >
      ...
      <input type="text" class="form-control"
       placeholder="Enter course id format like CSE_****"
      name="course_id" value="" required>
      <!-- <select class="form-control" name="course_id">
        ...
        course_assignment.teacher_name LIKE
        '%$name%' AND batch.state='Running'
        AND course_assignment.dept='$dept'
        group by course_assignment.course_id ";
        $send1=mysqli_query($connection,$query1);
        while ($row1=mysqli_fetch_array($send1)){
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" name="section" placeholder="Format : A/B.." value="" required>
