...
<h2  class="text-primary">  <center > <strong>For semestr final</strong></center></h2>
...
<div class="container col-sm-6 ">
 ...
 <h2 >  <center> </center></h2>
    <form  action="action_assign_semester_final.php" method="post">
  ...
  while ($row1=mysqli_fetch_array($send1)){
   ...
   ?>
    ...
    <div class="form-group" >
      ...
      placeholder="Enter course id format like CSE_**** " value="" required>
