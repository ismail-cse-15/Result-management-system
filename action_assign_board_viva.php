...
<div class="container col-sm-6">
  <h2  class="text-primary">  <center >
    <strong>For board viva </strong></center></h2>
<form class="" action="action_assign_board_viva1.php" method="post">
  <?php
  ...
  <div class="form-group">
    ...
    <div class="form-group">
      <label for="bv_marks">Marks</label>
      <input type="number" class="form-control"
      name="bv_marks" min="0" max="25"
      placeholder="Mark in range 0 to 25"
